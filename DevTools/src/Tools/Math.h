...
namespace Math
{
	...
	float Clamp(float x, float start = 0.0f, float end = 1.0f)
	{
	...
	glm::vec2 SmoothStep(glm::vec2 start, glm::vec2 end, float t)
	{
		t = Clamp(t);
	...
	glm::vec3 SmoothStep(glm::vec3 start, glm::vec3 end, float t)
	{
		t = Clamp(t);
